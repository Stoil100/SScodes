...
export default function LanguageSwitch() {
    ...
    const getIcon = (code: Language) => {
        switch (code) {
            case "en":
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-bg"  width={24} height={24} viewBox="0 0 640 480">
            ...
            case "bg":
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-gb" viewBox="0 0 640 480" width={24} height={24}>
